        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {isDashboard && (
              <button
                onClick={onMenuClick}
                className="md:hidden p-2 rounded-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
              >
                <MenuIcon />
              </button>
            )}

            <button onClick={onLogoClick} className="text-2xl font-bold text-gray-900 dark:text-white">
              MyGF AI
            </button>
          </div>
          ...
          <div className="flex items-center gap-2">
            {isDashboard && onLogout ? (
              ...
              <button
                ...
                className="text-white bg-indigo-600 hover:bg-indigo-700 px-3 py-2 rounded-md text-sm font-medium shadow-lg"
              >
                Agent Portal
              </button>
            )}
            ...
            <button
              ...
              className="p-2 rounded-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
