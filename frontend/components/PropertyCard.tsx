                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {showConnectButton && (
                            <button
                                ...
                                className="relative overflow-hidden bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-xl font-semibold text-sm transition-all shadow-lg hover:shadow-green-500/30 active:scale-95 flex items-center gap-2 group/btn"
                            >
