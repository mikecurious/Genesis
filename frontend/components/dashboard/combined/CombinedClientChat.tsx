...
interface CombinedClientChatProps {
...
export const CombinedClientChat: React.FC<CombinedClientChatProps> = ({ interactionChats, listings, humanTakeoverChats, onTakeoverChat, onSendAgentMessage }) => {
